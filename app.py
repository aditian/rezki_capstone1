...
def index():
	...
	plot_demographic_churn_res = plot_demographic_churn(raw)
	plot_demographic_cltv_res = plot_demographic_cltv(raw)
	...
	return render_template('index.html',
		 ...
		 plot_demographic_churn=plot_demographic_churn_res,
		 plot_demographic_cltv=plot_demographic_cltv_res
		)
